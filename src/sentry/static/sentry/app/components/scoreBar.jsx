...
const ScoreBar = React.createClass({
  ...
  render() {
    ...
    // Make sure palette index is between 0 and maxScore - 1
    let paletteIndex = score > maxScore - 1 ? maxScore - 1 : score < 0 ? 0 : score - 1;
    ...
    return (
      <div className={cx}>
        ...
        {[...Array(maxScore - paletteIndex)].map((j, i) => (
          <div
            style={{...sizeStyle}}
            key={`empty-${i}`}
